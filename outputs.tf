...
#  FIXME: this is not used in our stack and fails with tf0.12
...
#      compact(
#        concat(
#          [var.replicas_per_node_group == "0" ? "" : "Not set"],
#          aws_elasticache_replication_group.default.member_clusters,
#        ),
#      ),
#      0,
#    )
